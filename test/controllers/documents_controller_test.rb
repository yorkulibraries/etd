...
class DocumentsControllerTest < ActionController::TestCase
  ...
  context "as admin" do
    ...
    should "update attachments" do
       d = create(:document, file: fixture_file_upload("files/document-microsoft.doc", "application/text"), thesis: @thesis)
       ...
       assert_equal "/uploads/theses/#{@thesis.id}/files/#{d.id}/html-document.html", document.file.url, "new url shoud have html document"
  ...
  context "as student" do
    ...
    should "be able to upload another primary file if there is a primary file" do
      d = create(:document, file: fixture_file_upload("files/document-microsoft.doc", "application/text"), thesis: @thesis, supplemental: false)
      assert_no_difference "Document.count" do
         post :create,  params: { thesis_id: @thesis.id, student_id: @student.id,
    ...
    should "upload file and redirect to student thesis view" do
       ...
       assert_difference "Document.count" do
        ...
        assert_equal @thesis.id, document.thesis.id, "Current thesis should be set"
        assert_redirected_to student_view_thesis_process_path(@thesis, Thesis::PROCESS_UPLOAD), "Should redirect to student view upload process path"
    end
