...
<p>Once your submission is approved and all requirements for graduation are met, your thesis or dissertation will be submitted to YorkSpace, York University's digital library of research outputs and will be available for electronic viewing through Library and Archives Canada after it has been added to YorkSpace.</p><p>For step-by-step submission instructions and more information on ETD, <a href="https://www.yorku.ca/gradstudies/students/current-students/thesis-and-dissertation/">please visit FGS’s website.</a></p>
HEREDOC

AppSettings.student_begin_external_non_yorku_email = <<HEREDOC
<p>Please provide a secondary email address for future contact. Please note that this needs to be a non-York email address, in the event that your York email address is deactivated after your completion.</p>
HEREDOC
...
<p>By signing these non-exclusive distribution licences, you are confirming that:</p>
<ul><li>your dissertation is your original work;&nbsp;</li><li>that your dissertation does not infringe any rights of others;&nbsp;</li><li>and that as the copyright holder, you have the right to grant a non-exclusive distribution licence to York University, YorkSpace (the university’s institutional repository), and Library and Archives Canada (LAC).&nbsp;</li></ul>
...
<p>Please review the uploaded files and information below and confirm that everything is accurate, before you click the 'Submit for review' button.</p>
HEREDOC
...
<p>A record has been created for you to submit your thesis/dissertation. As long as the status is Open, you may continue to make changes until you are ready to submit.</p>
HEREDOC

AppSettings.student_check_status_under_review = <<HEREDOC
<p>Your submission has been received and is being reviewed by a Milestones and Progression Coordinator in the Faculty of Graduate Studies. If you need to re-open your ETD record to make any changes, <a href="https://www.yorku.ca/gradstudies/contact/fgs-staff-directory/">please visit the following page</a> to identify and contact the coordinator who supports your program.</p>
HEREDOC

AppSettings.student_check_status_returned = <<HEREDOC
<p>Your submission has been reviewed by a Thesis Coordinator and has been returned to you for modification. Please make the updates detailed in the email from the Thesis Coordinator, attach an updated PDF (if applicable) and resubmit.</p>
HEREDOC

AppSettings.student_check_status_accepted = <<HEREDOC
<p>Your submission has been accepted and will be published following conferral of your degree.</p>
HEREDOC
