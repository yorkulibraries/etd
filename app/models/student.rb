class Student < User
   ...
   IMMUTABLE_THESIS_FIELDS = %w(title author supervisor committee exam_date program degree_name degree_level embargo published_date id gem_record_event_id status)
