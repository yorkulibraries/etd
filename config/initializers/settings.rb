...
if ActiveRecord::Base.connection.data_source_exists? 'settings'
  ...
  AppSettings.save_default(:app_maintenance_message,
                           'ETD Application will be taken down for maintenance today from 12pm to 1pm.  We appologize for any inconvenience this may have caused.')
  ...
  AppSettings.save_default(:email_welcome_subject,
